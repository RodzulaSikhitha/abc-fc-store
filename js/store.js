...
const PRODUCTS = [
  ...
  {
    id: 'p2',
    name: '2025/26 Hooped Jersey (Gold)',
    category: ['kits'],
    price: 199.99,
    oldPrice: null,
    badge: 'new',
    description: 'Gold and navy hooped ABC FC jersey, gold "Lion of the North" crest on the chest and crowned lion head on the back. 100% polyester moisture-wicking fabric.',
    sizes: ['XS','S','M','L','XL','XXL'],
    soldOut: false,
    image: 'images/products/yellow-hooped-jersey.jpeg',
    svgColor: '#d4af00',
  },
  {
    id: 'p3',
    name: '2025/26 Hooped Jersey (Red)',
    category: ['kits'],
    price: 199.99,
    oldPrice: null,
    badge: 'new',
    description: 'Red and navy hooped ABC FC jersey with gold "Lion of the North" crest on the chest. 100% polyester moisture-wicking fabric.',
    sizes: ['XS','S','M','L','XL','XXL'],
    soldOut: false,
  ...
  },
  {
    ...
    oldPrice: null,
    badge: 'new',
    description: 'Official ABC FC goalkeeper jersey in bold red with gold "Lion of the North" crest. Long-sleeve, moisture-wicking polyester — built for the last line of defence.',
    sizes: ['XS','S','M','L','XL','XXL'],
    soldOut: false,
    image: 'images/products/gk-jersey-red.jpeg',
    svgColor: '#b3122b',
  },
  {
    id: 'p5',
    name: 'GK Jersey (Black)',
    category: ['kits'],
    price: 199.99,
    oldPrice: null,
    badge: 'new',
    description: 'Official ABC FC goalkeeper jersey in stealth black with white collar detail and gold "Lion of the North" crest. Long-sleeve, moisture-wicking polyester.',
    sizes: ['XS','S','M','L','XL','XXL'],
    soldOut: false,
    image: 'images/products/gk-jersey-black.jpeg',
    svgColor: '#111111',
  },
  {
    id: 'p6',
    name: 'ABC FC Drawstring Bag',
    category: ['accessories'],
    price: 100,
    oldPrice: null,
    badge: 'new',
    description: 'Black drawstring gymsack with the full ABC FC Football Club gold crest print. Perfect for training days or match day kit.',
    sizes: ['One Size'],
    soldOut: false,
    image: 'images/products/drawstring-bag.jpeg',
    svgColor: '#222222',
  },
  {
    id: 'p7',
    name: 'ABC FC Puffer Jacket',
    category: ['accessories'],
    price: 900,
    oldPrice: null,
    badge: 'new',
    description: 'Navy puffer jacket with an embroidered ABC FC Foundation "Lion of the North" badge. Warm, lightweight, and officially branded — wear your pride off the pitch.',
    sizes: ['XS','S','M','L','XL','XXL'],
    soldOut: false,
    image: 'images/products/puffer-jacket.jpeg',
    svgColor: '#0c1830',
  },
  {
    id: 'p8',
